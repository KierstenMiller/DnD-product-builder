...
import { type buildYourOwnRawDataI, type validationLibraryT } from '-/page-components/build-your-own/build-your-own.types'
...
const BuildYourOwn = () => {
  ...
  return (
        <>
            ...
            <BuildYourOwnPage model={model} modifiers={data.modifiers} globalValidation={data.builder?.rules} { ...validationLibrary.length > 0 && { validationLibrary }}/>
        </>
  )
}
