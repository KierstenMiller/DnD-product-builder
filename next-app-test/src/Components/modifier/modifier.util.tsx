import { groupByValues, groupKeyValues, sortAlphaI, sortByValues, sortNumI } from '-/Components/modifier/modifier.types';
import { modifiersT, optionsT } from '-/page-components/build-your-own/build-your-own.types';

//////////////////////////
//      GENERAL USE     //
//////////////////////////
// returns object, keys are grouping key and values are an array of items
