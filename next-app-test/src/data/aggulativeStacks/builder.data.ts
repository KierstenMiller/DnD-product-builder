...
export const aggulativeStacksMock1 = [
    [
        ...
        { column: 1, piece: {id:'piece-3', config: [{id: 'mod-height', selection: '1'}]}},
    ],
    [
        { column: 2, piece: {id:'piece-4', config: [{id: 'mod-height', selection: '1'}]}},
    ],
    [
        { column: 3, piece: {id:'piece-5', config: [{id: 'mod-height', selection: '1'}]}},
    ],
    [
        { column: 4, piece: {id:'piece-6', config: [{id: 'mod-height', selection: '1'}]}},
        { column: 4, piece: {id:'piece-7', config: [{id: 'mod-height', selection: '1'}]}},
        { column: 4, piece: {id:'piece-8', config: [{id: 'mod-height', selection: '1'}]}},
...
export const aggulativeStacksMock4 = [
    [
        ...
        { column: 3, piece: {id:'piece-3', config: [{id: 'mod-height', selection: '4'}]}},
        { column: 4, piece: {id:'piece-4', config: [{id: 'mod-height', selection: '4'}]}},
    ],
];