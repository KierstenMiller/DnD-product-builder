import { type aggulativeStackIndexI, type aggulativeStacksListT, type globalRulesI, type pieceI, type stackI, type validationLibraryT } from '-/page-components/build-your-own/build-your-own.types'
