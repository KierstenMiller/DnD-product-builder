import { type aggulativeStackIndexI, type aggulativeStacksListT, type globalRulesI, type pieceI, type stackI, type validationLibraryT } from '-/build-your-own/shared/typing/build-your-own.types'
