import { modifiers as rentalModifiers } from '-/build-your-own/data/aggulativeStacks/rental/modifiers.data'
import { rentalStacksMock } from '-/build-your-own/data/aggulativeStacks/rental/stacks.data'
import { modifiers } from '-/build-your-own/data/aggulativeStacks/testingMocks/modifiers.data'
import { aggulativeStacksMock1 } from '-/build-your-own/data/aggulativeStacks/testingMocks/stacks.data'
import { matrixMock } from '-/build-your-own/data/freeformMatrix/matrix.data'
import { shapeModifiers } from '-/build-your-own/data/freeformMatrix/modifiers.data'
import { robotModifiers } from '-/build-your-own/data/singleton/robots/modifiers.data'
import { mockModifierA, mockModifierB, mockModifierC, mockModifierD, mockModifierE } from '-/build-your-own/data/singleton/testingMocks/modifiers.data'
import { builderKeys } from '-/build-your-own/page-state/compilePageData.util'
